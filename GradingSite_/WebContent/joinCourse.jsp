...
if(session.getAttribute("type").toString().equals("students") ){ 
	...
	if(coursName != null){
		System.out.println("- joinCourse : " + coursName);
		CoursesAndGradesTasks coursesAndGradesTasks = new CoursesAndGradesTasks();
		boolean courseID = coursesAndGradesTasks.joinCourse(studentOpject , coursName);
		if(courseID ){
...
<div id="about" class="container-fluid">
   	<form class="form-inline" name="login" id="login" method="post"> 
		...
		<button type="submit" class="btn btn-primary btn-md">Join</button>
	</form>
